...
class CharacterCardsPanel(QDialog):
    ...
    def __init__(self, manager: CharacterCardManager, parent=None):
        ...
        self._card_list.setAccessibleName("Character Cards")
        ...
        add_btn.setAccessibleName("New Card")
        ...
        auto_btn.setAccessibleName("Auto-populate from Script")
        ...
        del_btn.setAccessibleName("Delete Card")
    ...
    def _build_bio_tab(self):
        ...
        self._bio_full_name.setAccessibleName("Full Name")
        self._bio_nickname = QLineEdit()
        self._bio_nickname.setAccessibleName("Nickname")
        self._bio_age = QLineEdit()
        self._bio_age.setAccessibleName("Age")
        self._bio_gender = QLineEdit()
        self._bio_gender.setAccessibleName("Gender")
        self._bio_occupation = QLineEdit()
        self._bio_occupation.setAccessibleName("Occupation")
        self._bio_physical = QLineEdit()
        self._bio_physical.setAccessibleName("Physical")
        self._bio_backstory = QTextEdit()
        self._bio_backstory.setMaximumHeight(80)
        self._bio_backstory.setAccessibleName("Backstory")
        self._bio_motivation = QLineEdit()
        self._bio_motivation.setAccessibleName("Motivation")
        self._bio_speech = QLineEdit()
        self._bio_speech.setAccessibleName("Speech Pattern")
    ...
    def _build_arc_tab(self):
        ...
        self._arc_wants.setAccessibleName("Wants")
        self._arc_needs = QLineEdit()
        self._arc_needs.setAccessibleName("Needs")
        self._arc_flaw = QLineEdit()
        self._arc_flaw.setAccessibleName("Flaw")
        self._arc_summary = QTextEdit()
        self._arc_summary.setMaximumHeight(80)
        self._arc_summary.setAccessibleName("Arc Summary")
        self._arc_notes = QTextEdit()
        self._arc_notes.setMaximumHeight(80)
        self._arc_notes.setAccessibleName("Notes")
